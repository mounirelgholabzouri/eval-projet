        ...
        <tbody>
            ...
            <tr>
                <td class="col-note">
                    ...
                    <span style="font-weight:normal;font-size:9pt;color:#555">/ <?= number_format($ptsMaxScal, 2) ?></span>
                </td>
                <td class="col-q">
                    <div class="q-text">
                    ...
                    <div style="margin:3px 0 0 6px;font-size:10pt;line-height:1.7">
                        ...
                        ?>
                        <span style="display:inline-block;<?= $isCorrect ? 'font-weight:bold' : '' ?>;margin-right:16px;margin-bottom:4px;vertical-align:middle">
                            <span style="display:inline-block;width:13px;height:13px;border:1px solid #555;vertical-align:middle;margin-right:4px"></span><?php if ($isCorrect): ?>&#10003;<?php elseif ($isSelected): ?>&rarr;<?php else: ?>&nbsp;<?php endif; ?> <?= sanitize($c['texte']) ?>
                        </span>
                        <?php endforeach; ?>
                    </div>
                    <?php else: ?>
