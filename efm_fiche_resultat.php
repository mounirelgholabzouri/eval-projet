            ...
            <tr>
                ...
                <td class="col-q">
                    ...
                    <div style="margin:3px 0 0 6px;font-size:10pt;line-height:1.7">
                        ...
                        ?>
                        <span style="display:inline-block;<?= $isCorrect ? 'font-weight:bold' : '' ?>;margin-right:16px;margin-bottom:4px;vertical-align:middle &#9744; <?php if ($isCorrect): ?>&#10003;<?php elseif ($isSelected): ?>&rarr;<?php endif; ?> <?= sanitize($c['texte']) ?></span>
                        <?php endforeach; ?>
                    </div>
                    <?php else: ?>
