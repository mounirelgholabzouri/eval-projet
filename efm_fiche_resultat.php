                ...
                <td class="col-q">
                    ...
                    <div style="margin:3px 0 0 6px;font-size:10pt;line-height:1.7">
                        ...
                        <div style="display:flex;align-items:flex-start;<?= $isCorrect ? 'font-weight:bold' : '' ?>;margin-bottom:4px;gap:6px">
                            <span style="display:inline-block;min-width:14px;width:14px;height:14px;border:1px solid #555;flex-shrink:0;margin-top:1px"></span><span><?php if ($isCorrect): ?>&#10003;<?php elseif ($isSelected): ?>&rarr;<?php else: ?>&nbsp;<?php endif; ?> <?= sanitize($c['texte']) ?></span>
                        </div>
                        <?php endforeach; ?>
                    </div>
                    <?php else: ?>
